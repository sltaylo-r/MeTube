      ...
      <div class="content-container">
          ...
          <div class="left-column">
            <ul class="navigation-list-left">
                ...
                <li><a class="active" href="messages.php">Inbox</a></li>
            ...
            <div class="messages-container">
                <table id="messageTable">
                    <tr class="header">
                        ...
                        <th id="username" style="width:20%"><button class="sort-button" type="button" onclick="sortRows(1)">Received From</button></th>
                    ...
                    <?php
                        ...
                        $stmt = $mysqli->prepare("SELECT Conv_ID, username, User_ID_Send, Message, Timestamp FROM Conversation LEFT JOIN User on Conversation.User_ID_Send = User.User_ID WHERE User_ID_Receive = '$userid' ORDER BY Timestamp DESC;");
                            ...
                            while($stmt->fetch()) {
                                ...
                                echo '<tr>
                                        <form method="post" action="message_show.php" id="conversation-form">
                                            <input type="hidden" name="receiveID" value='.$userid_send_entry.'>
                                            <input type="hidden" name="convID" value='.$convid_entry.'>
                                            <input type="hidden" name="sentView" value="0">
                                            <td>
                                                <label>'.$timestamp_entry.'</label>
                                            </td>
                                            <td>
                                ...
                                /*echo '<form action="message_show.php" id="conversation-form" method="get">
                                    <label>'.$timestamp_entry.'</label>
                                    <label>'.$username_entry.'</label>
                                    <input type="hidden" name="receiveID" value='.$userid_send_entry.'>
                                    <input type="hidden" name="convID" value='.$convid_entry.'>
