          ...
          <div class="right-column">
            ...
            <div class="wrapper">
                ...
                <?php
                  ...
                  $stmt = $mysqli->prepare("SELECT Video_ID FROM Favorite_List WHERE User_ID = '$userid'");
                  ...
                  $video_array = array();
                  for($i = 0; $i < $length; $i++){
                      $tempVideoID = $id_array[$i][0];
                      $stmt = $mysqli->prepare("SELECT Video_Name, Video_Thumbnail_File, Video_ID FROM Video WHERE Video_ID = '$tempVideoID'");
                      if(!$stmt->execute()) { print("Error video information."); } else {
