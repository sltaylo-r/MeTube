          ...
          <div class="right-column">
            ...
            <div class="wrapper">
                ...
                <?php
                  ...
                  $video_array = array();
                  $stmt = $mysqli->prepare("SELECT Video_Name, Video_Thumbnail_File, Video_ID FROM Video WHERE User_ID = '$var_value'");
                  ...
                  $stmt = $mysqli->prepare("SELECT username FROM User WHERE User_ID = '$var_value'");
                  if(!$stmt->execute()) { print("Error video information."); } else {
                    $stmt->bind_result($user_name);
                    $stmt->fetch();
                    $stmt->close();
                  }
                  echo '<div><p class="channelName"><b>'.$user_name.'&#39s channel</b></p></div>';
                  echo '</br>';
